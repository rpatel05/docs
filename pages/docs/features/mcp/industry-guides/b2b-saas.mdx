...
```text
Show me a funnel from signup → workspace created → first invite → first report built, by plan type
...
What's the funnel from trial → activation milestone → upgrade conversation → paid conversion?
